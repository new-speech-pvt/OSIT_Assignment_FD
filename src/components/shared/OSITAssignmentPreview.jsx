    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-white to-body-20 flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <h3 className="text-xl md:h4 text-body-100 mt-4 md:mt-6 font-semibold">
            Loading Assignment
          </h3>
          <p className="text-body-50 mt-2 text-sm">
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-white to-body-20 flex items-center justify-center p-4">
        <div className="text-center max-w-md w-full mx-4">
          ...
          <h3 className="text-xl md:h4 text-body-100 font-semibold mb-2">
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 lg:px-8">
        ...
        >
          <div className="text-center mb-4 md:mb-6">
            ...
            <h1 className="text-2xl md:h1 text-body-100 font-bold mb-2">
              OSIT Assignment
            </h1>
            <p className="text-body-70 text-sm md:text-lg">
              Comprehensive overview of assignment details
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 md:gap-4 mb-4 md:mb-6">
            <div className="bg-body-20 rounded-lg md:rounded-xl p-3 md:p-4 text-center">
              <div className="text-lg md:text-2xl font-bold text-primary-100">
                {scoring?.totalObtained || 0}
              </div>
            ...
            <div className="bg-body-20 rounded-lg md:rounded-xl p-3 md:p-4 text-center">
              <div className="text-lg md:text-2xl font-bold text-ternary-100">
                {
                  Object.keys(assignment?.interventionPlan || {}).filter(
                    (key) => key.startsWith("week")
                  ).length
                }
              </div>
            ...
            <div className="bg-body-20 rounded-lg md:rounded-xl p-3 md:p-4 text-center">
              <div className="text-lg md:text-2xl font-bold text-body-100">
                {assignment?.interventionPlan
                  ? Object.values(assignment.interventionPlan).reduce(
            ...
            {scoring && role === "THERAPIST" && (
              <div className="bg-gradient-to-br from-secondary-50/20 to-secondary-70/10 rounded-xl md:rounded-2xl p-4 md:p-6 border border-secondary-50/30">
                <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
                  ...
                  <div>
                    <h2 className="text-base md:h4 text-body-100 font-semibold">
                      Therapist
                    </h2>
                ...
                <div className="space-y-2 md:space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-body-70 text-sm">
                      {data?.scoring?.therapist?.name}
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Mail className="w-3 h-3 md:w-4 md:h-4 text-body-50" />
                    <span className="text-body-70 text-sm truncate">
                      {scoring?.therapist?.email}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2 md:space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-body-70 text-sm capitalize">
                    {assignment?.participantInfo?.fName}{" "}
                ...
                <div className="flex items-center gap-2">
                  <Mail className="w-3 h-3 md:w-4 md:h-4 text-body-50" />
                  <span className="text-body-70 text-sm truncate">
                    {assignment?.participantInfo?.email}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <Phone className="w-3 h-3 md:w-4 md:h-4 text-body-50" />
                  <span className="text-body-70 text-sm">
                    {assignment?.participantInfo?.phone}
                  </span>
                </div>
              </div>
            </div>
        ...
        >
          <div className="flex items-center gap-2 md:gap-3 mb-4 md:mb-6">
            ...
            <div>
              <h2 className="text-lg md:h3 text-body-100 font-semibold">
                Child Profile
              </h2>
              <p className="text-body-50 text-xs md:text-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 lg:gap-6">
            <div className="space-y-1">
              <label className="text-body-50 text-xs md:text-sm font-medium">
                Full Name
              </label>
            ...
            <div className="space-y-1">
              ...
              <p className="text-body-100 font-medium text-sm md:text-base capitalize">
                {assignment?.childProfile?.gender}
              </p>
            </div>
            <div className="space-y-1">
              <label className="text-body-50 text-xs md:text-sm font-medium">
            ...
            <div className="space-y-1">
              ...
              <p className="text-body-100 font-medium text-sm md:text-base">
                {assignment?.childProfile?.diagnosis}
              </p>
            </div>
            <div className="space-y-1">
              <label className="text-body-50 text-xs md:text-sm font-medium">
          ...
          {assignment?.childProfile?.medicalHistory && (
            <div className="mt-4 md:mt-6">
              <label className="text-body-50 text-xs md:text-sm font-medium block mb-2 md:mb-3">
                Medical History
              </label>
              <div
            ...
            {Object.entries(assignment?.assignmentDetail || {}).map(
              ([key, value]) => {
                ...
                return (
                  <div
                    key={key}
                    className="border-b border-body-30 pb-4 md:pb-6 last:border-b-0 last:pb-0"
                  >
          ...
          <div className="space-y-3 md:space-y-4">
            {Object.entries(assignment?.interventionPlan || {})
              ...
              .map(([week, weekData]) => (
                <div
                  key={week}
                  className="border border-body-30 rounded-lg md:rounded-xl overflow-hidden"
                >
                  <button
                  ...
                  >
                    <div className="flex items-center gap-2 md:gap-3">
                      ...
                      <div className="text-left">
                        <h3 className="font-semibold text-body-100 text-sm md:text-base capitalize">
                          {week}
                        </h3>
                        <p className="text-body-50 text-xs md:text-sm">
                        ...
                        <div className="p-4 md:p-6 bg-body-20 border-t border-body-30">
                          <div className="grid gap-3 md:gap-4">
                            {weekData?.sessions?.map((session, index) => (
                              <div
                                key={session._id}
                                className="bg-white rounded-lg md:rounded-xl p-3 md:p-4 border border-body-30"
                              >
                                <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-3">
                                  ...
                                  <div>
                                    <h4 className="font-semibold text-body-100 text-sm md:text-base">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 text-xs md:text-sm">
                                  <div>
                                    <label className="text-body-50 font-medium">
                                      Goals
                                    </label>
                                    <div className="flex flex-wrap gap-1 mt-1">
                                      {session.goal.map((goalItem, idx) => (
                                        <span
                                          key={idx}
                                          className="bg-primary-50/20 text-primary-100 px-2 py-1 rounded text-xs"
                                        >
                                          {goalItem}
                                        </span>
                                      ))}
                                    ...
                                    <div className="flex flex-wrap gap-1 mt-1">
                                      {session.activity.map(
                                        (activityItem, idx) => (
                                          <span
                                            key={idx}
                                            className="bg-secondary-50/20 text-secondary-100 px-2 py-1 rounded text-xs"
                                          >
                                            {activityItem}
                                          </span>
                                        )
                                ...
                                {session.childResponse && (
                                  <div className="mt-2 md:mt-3">
                                    <label className="text-body-50 font-medium text-xs md:text-sm">
                                      Child Response
                                    </label>
                                    <p className="text-body-70 text-xs md:text-sm mt-1">
                                      {session.childResponse}
                                    </p>
                                  </div>
                                )}
          ...
          >
            ...
            <div className="lg:hidden space-y-3">
              {scoring?.criteriaList?.map((item, index) => (
                <div
                  key={item._id}
                  className="border border-body-30 rounded-lg p-3 bg-body-20/30"
                >
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="font-semibold text-body-100 text-sm flex-1 pr-2">
                      {item.criteria}
                    </h3>
                  ...
                  {item.remarks && (
                    <p className="text-body-70 text-xs mt-2">
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gradient-to-r from-secondary-70 to-secondary-100 text-white">
                    <th className="p-3 md:p-4 text-left font-semibold rounded-tl-xl">
                      Criteria
                    </th>
                    ...
                    <th className="p-3 md:p-4 text-left font-semibold rounded-tr-xl">
                      Remarks
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {scoring?.criteriaList?.map((item, index) => (
                    ...
                    >
                      <td className="p-3 md:p-4 font-medium text-body-100 text-sm">
                        {item.criteria}
                      </td>
                      <td className="p-3 md:p-4 text-center text-body-70 text-sm">
                        {item.maxMarks}
                      </td>
                      ...
                      <td className="p-3 md:p-4 text-body-70 text-sm">
                        {item.remarks}
                      </td>
                    </tr>
                  ))}
