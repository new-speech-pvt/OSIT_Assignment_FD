      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-body-70 text-lg">
            Manage and review your therapy assignments
          </p>
        </motion.div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="ml-auto bg-body-20 px-4 py-2 rounded-xl">
                <p className="text-body-70 text-sm font-semibold">
                  ...
                  {data.assignments.length === 1 ? "Assignment" : "Assignments"}
                </p>
              </div>
            </div>
          </motion.div>
                          ...
                          {hasScore ? (
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <div>
                                  ...
                                  <p className="text-body-100 font-bold text-lg">
                                    {totalScore}
                                    <span className="text-body-50 font-normal">
                                      /{totalPossible}
                                    </span>
                                  </p>
                                </div>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                ...
                                <p className="text-body-100 font-semibold">
                                  Awaiting Assessment
                                </p>
                              </div>
                            </div>
        ...
        {data.assignments.length === 0 && (
          ...
          >
            ...
            <h3 className="h4 text-body-70 font-semibold mb-2">
